<?php
	...
	class Parceiros_Widget extends WP_Widget
	{
	    ...
	    function widget($args, $instance)
	    {
	        ...
	        <a <?php if( !empty($instance['link']) && $instance['link'] != '#' ): echo 'href="'.apply_filters('widget_title', $instance['link']).'" target="_blank"';  endif; ?>><img class="parceiroImg" data-scrollreveal="enter left after 0s over 1s"
