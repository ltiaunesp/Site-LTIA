...
function sendSlackUpdate($id = 0){
	if(($id + 0) == 0 || !class_exists("MyUsersClass"))
		return;
	global $current_user;get_currentuserinfo();
	MyUsersClass::slackMessage($current_user->ID, "O usuário: ". $current_user->display_name .", postou uma nova ideia no site verifique aqui <". get_permalink($id) .">");
}
