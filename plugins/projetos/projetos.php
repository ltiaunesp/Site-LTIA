<?php
	...
	//USERMETA https://developer.wordpress.org/plugins/users/working-with-user-metadata/ e http://www.paulund.co.uk/add-upload-media-library-widgets
		...
		class MyProjectsUsersClass{
			...
			function sendSlackUpdateProject($post){ // DE PROJETO
				if(!class_exists("MyUsersClass") || !self::is_project($post))
					return;
				global $current_user;get_currentuserinfo();
				MyUsersClass::slackMessage($current_user->ID, "O usu�rio: ". $current_user->display_name .", postou um novo projeto no site.\nVerifique aqui: <". get_permalink($id) .">");
			}
