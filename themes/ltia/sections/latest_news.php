		...
		<section class="latest-news blockSection" id="blog">
			<div class="container">
				...
				<?php
					...
					if( !empty($zerif_latestnews_title) ):
						...
						echo '<h2 class="dark-text">' . "&Uacute;ltimas Postagens:" . '</h2>';
					endif;
				...
				<div id="carousel-homepage-latestnews" class="carousel slide" data-ride="carousel">
					...
					<?php
						$args = array( 'post_type' => 'post', 'cat' => '-' . get_category_by_slug('projetos')->term_id, 'posts_per_page' => get_option('posts_per_page',10), 'order' => 'DESC');
			...
			<a href="<?php echo $pathWordpress; ?>index.php/blog/">Ver mais</a>
		</section>
		<?php } ?>
