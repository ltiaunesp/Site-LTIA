...
var ParallaxScroll = {
    ...
    /* PRIVATE VARIABLES */
    _inited: false,
    _properties: ['x', 'y', 'z', 'rotateX', 'rotateY', 'rotateZ', 'scaleX', 'scaleY', 'scaleZ', 'scale', 'grayscale', 'alpha', 'callback', 'opacity-in', 'opacity-out'],
        ...
        $("[data-parallax]").each($.proxy(function(index, el) {
            ...
            for(iData = 0; iData < datasLength; iData ++) {
                ...
                this._properties.map($.proxy(function(prop) {
                    if(prop == "callback" && data[prop] !== undefined){ 
                    ...
                    if(prop=="scale" || prop=="scaleX" || prop=="scaleY" || prop=="scaleZ" || prop=="opacity-out") 
                        defaultProp = 1;
                    if(prop=="opacity-in")
                        defaultProp = 0;
            ...
            if (applyProperties) {
				...
				var filter = "grayscale("+properties['grayscale']+"%);";
                var opacity = undefined;
                if(properties["opacity"] !== undefined){
                    filter += " alpha(opacity="+ (properties["opacity"] * 100) + ");";
