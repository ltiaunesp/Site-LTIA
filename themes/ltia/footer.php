...
<div class="container">
	...
	<div class="col-md-2" id="socialFooter">
		...
		<a href="https://www.linkedin.com/company/ltia---laborat-rio-de-tecnologia-da-informa-o-aplicada"><i class="fa fa-linkedin"></i></a>
		<a href="<?php echo admin_url();?>"><i class="fa fa-lock"></i></a>
